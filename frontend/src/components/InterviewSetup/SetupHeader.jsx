    ...
    <header className="w-full top-0 sticky z-30 bg-slate-950/60 backdrop-blur-xl shadow-[0_20px_50px_rgba(11,19,38,0.3)] flex justify-between items-center px-4 md:px-8 py-4">
      <div className="flex items-center gap-4 md:gap-8">
        ...
        <div className="hidden lg:flex gap-6">
          <span className="font-headline tracking-tight text-slate-400 hover:text-slate-200 transition-colors">Dashboard</span>
          <span className="font-headline tracking-tight text-blue-400 border-b-2 border-blue-400 pb-1">Interview</span>
